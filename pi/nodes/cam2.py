...
- /cam2/image_raw (sensor_msgs/Image)
- /cam2/camera_info (sensor_msgs/CameraInfo)
"""
...
def _import_libcamera():
    ...
    try:
        ...
        raise RuntimeError(
            "python3-libcamera is required for cam2. Install: sudo apt install -y python3-libcamera"
        ) from exc
    return libcam
...
def main():
    parser = argparse.ArgumentParser(description="CSI camera ROS2 node (cam2, python3-libcamera)")
